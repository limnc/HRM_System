...
@section('pageHeader','Add Employee')
@section('content')
<style>
    .image_container {
        width: 300px;
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <form action="{{url('addEmployee/add')}}" method="post" autocomplete="off" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="row">
                        ...
                        <div class="col-8">
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-8">
                                    ...
                                    @error('empName')
                                    <li class="text-danger"><i class="bi bi-exclamation"></i>Name field is required</li>
                                    @enderror
                                </div>
                            </div>
                            <br>
...
<script>
    var images = [];
    let imageFile = document.getElementById("profilePic");
    var isValid = false;
